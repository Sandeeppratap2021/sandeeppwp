...
<div id="wrap">
	<div class="wpnw-sf-wrap">
		...
		<div class="wpnw-sf-features-section wpnw-sf-team wpnw-sf-center">
				...
				<h1 class="wpnw-sf-heading">Only <span class="wpnw-sf-blue">November 2022</span> Deal <span class="wpnw-sf-blue">40% OFF</span></h1>
				...
				<a href="<?php echo WPNW_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wpnw-sf-btn wpnw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
			...
			<div class="wpnw-sf-features-section wpnw-sf-team wpnw-sf-center">
				<h1 class="wpnw-sf-heading">Powerful Team Behind <span class="wpnw-sf-blue">News Builder</span> Including in <span class="wpnw-sf-blue">Essential Plugin Bundle</span></h1>
					...
					<p></p>
					<div class="wpnw-sf-cont">This is why I wanted to introduce you to <span class="wpnw-sf-blue">Essential Plugin Team</span> at essentialplugin.com</div>
					<img class="wpnw-sf-image" src="<?php echo WPNW_URL; ?>/assets/images/wpos-team.png" alt="wpos team" />
					<a href="<?php echo WPNW_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wpnw-sf-btn wpnw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
			</div>
			...
			<div class="wpnw-sf-welcome-wrap">
				<div class="wpnw-sf-welcome-inr wpnw-sf-center">
					...
					<a href="<?php echo esc_url( $wpnw_add_link ); ?>" class="wpnw-sf-btn">Launch News With Free Features</a> <br /><b>OR</b> <br />
					<p style="font-size: 14px;"><span class="wpnw-sf-blue">News </span>Including in <span class="wpnw-sf-blue">Essential Plugin Bundle</span></p>
					<a href="<?php echo WPNW_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpnw-sf-btn wpnw-sf-btn-orange"> <span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
					...
					<div class="wpnw-sf-welcome-left"></div>
					<div class="wpnw-sf-welcome-right"></div>
				</div>
			</div>
			<!-- End - Welcome Box -->
			...
			<div class="wpnw-sf-testimonial-wrap">
				<div class="wpnw-sf-center wpnw-sf-features-ttl">
					<h1 class="wpnw-sf-heading">Looking for a Reason to Use <span class="wpnw-sf-blue">Essential Plugin </span>with News?</h1>
				...
				<div class="wpnw-testimonial-section-inr">
					...
					<a href="https://wordpress.org/support/plugin/sp-news-and-widget/reviews/?filter=5" target="_blank" class="wpnw-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a> OR 
					<p style="font-size: 14px;"><span class="wpnw-sf-blue">News </span>Including in <span class="wpnw-sf-blue">Essential Plugin Bundle</span></p>
					<a href="<?php echo WPNW_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpnw-sf-btn wpnw-sf-btn-orange"> <span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
					<div class="wpnw-rc-wrap">
						<div class="wpnw-rc-inr wpnw-rc-bg-box">
