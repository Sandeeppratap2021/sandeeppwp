...
class Event_Management_Custom_Control extends WP_Customize_Control {
...
class event_management_Image_Radio_Control extends WP_Customize_Control {
    public function render_content() {
        ...
        <ul class="controls" id='event-management-img-container'>
            <?php
            foreach ($this->choices as $value => $label) :
                $class = ($this->value() == $value) ? 'event-management-radio-img-selected event-management-radio-img-img' : 'event-management-radio-img-img';
                ?>
